  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <NetworkNav 
        ...
        siteColor="bg-gradient-to-r from-indigo-400 via-purple-400 to-blue-400 text-transparent bg-clip-text"
      />
      ...
      <footer className="border-t border-gray-800 py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-400">
          <p className="text-sm">Git is Eternal • Timeless • Immortal • Permanent</p>
